    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            <div class="tstream" id="tstream<?php echo $counter; ?>">
                <iframe width="100%" height="100%" src="<?php echo $row['twitch'] ?>?autoplay=true"
...
<div id="links">
    <table>
        <tr>
            <th>
                <div onclick="show3('block')">Connect with:</div>
            </th>
            <th>Help:</th>
            <th>Powered by:</th>
        </tr>
        <tr>
            ...
            <td>
                <div id="click" onclick="show2('block')">How does it work?</div>
            </td>
...
<div id="popUp2">
    ...
    <h3>
        ...
        You can make a donation by clicking the Firefly logo in the top-left of the page. It will bring up the popUp
        window with QR codes. By scanning the QR code you can make a donation in IOTAs. Alternatively, you can make a
        transaction by entering the wallet adress manually. When transaction gets processed you will see the amount of
        kwH (which depends on the current kwH/IOTA conversion rate) deposited on the sensor on the live video feed.
        Enjoy, and thanks for your donations!
    </h3>
</div>
