...
const insertTransaction = function instTransaction(transactionId) {
    ...
    return new Promise(function (resolve, reject) {
        var query_str =
            "INSERT INTO conversions (crypto_name, rate_to_euro,last_updated) VALUES (?, '',null)";

        var query_var = [transactionId];
